...
class LambdaStack(core.Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        dev_account_id = "905418350870"  # Replace with your development account ID
        ...
        my_lambda = Function(
            ...
            role=Role.from_role_arn(self, 'lambdarole1', role_arn=f'arn:aws:iam::{account_id}:role/awslambda_v1'),
            memory_size=128,
